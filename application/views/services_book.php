      ...
      <div class="row g-4">
         <div class="col-lg-12">
            <div class="form-wrap box--shadow mb-30">
               ...
               <form action="<?=base_url('home/add_services_book/'),$get_id[0]->id?>" method="post" id="form_data">
                  <div class="row">
                     <div class="col-12">
                     ...
                     <div class="col-12">
                        <div class="form-inner">
                           ...
                           <input type="text"  name="mobile" id="mobile"placeholder="Enter your mobile number"   pattern="^(\+91[\-\s]?)?[0]?(91)?[6789]\d{9}$"
                           ...
                           <!--<input type="text" name="mobile" id="mobile" placeholder="Your Phone Number"pattern="[6789][0-9]{9}" title="Please enter valid phone number"  onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))">-->
                        </div>
                     </div>
                     <div class="col-12">
                        <div class="form-inner">
                     ...
                     <!--<div class="nice-select" tabindex="0" name="service_type"><span class="current">Choose Services...</span>-->
                     ...
                     <!--<li data-value="<?=$row->heading?>" class="option"><?=$row->heading?></li>-->
                     <!--<li data-value="Bathing" class="option">Bathing</li>-->
