...
<head>
    ...
    <link href="<?= base_url()?>assets/plugins/src/apex/apexcharts.css" rel="stylesheet" type="text/css">
    <link href="<?= base_url()?>assets/css/light/dashboard/dash_1.css" rel="stylesheet" type="text/css" />
    <!--<link href="<?= base_url()?>assets/css/dark/dashboard/dash_1.css" rel="stylesheet" type="text/css" />-->
...
<body class="layout-boxed">
                        ...
                        <div class="notification-scroll">
                            <div class="dropdown-item">
                                <div class="media server-log">
                                    <img src="<?= base_url()?>assets/assets/img/profile-16.jpg" class="img-fluid me-2" alt="avatar">
                            ...
                            <div class="dropdown-item">
                                <div class="media ">
                                    <img src="<?= base_url()?>assets/assets/img/profile-15.jpg" class="img-fluid me-2" alt="avatar">
                                    <div class="media-body">
                                        <div class="data-info">
                            ...
                            <div class="dropdown-item">
                                <div class="media file-upload">
                                    <img src="<?= base_url()?>assets/assets/img/profile-21.jpg" class="img-fluid me-2" alt="avatar">
                                    <div class="media-body">
                                        <div class="data-info">
                    ...
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="avatar-container">
                            <div class="avatar avatar-sm avatar-indicators avatar-online">
                                <img alt="avatar" src="<?= base_url()?>assets/assets/img/profile-30.png" class="rounded-circle">
                            </div>
                        </div>
                    </a>
                ...
                <div class="profile-info">
                    <div class="user-info">
                        <div class="profile-img">
                            <img src="<?= base_url()?>assets/assets/img/profile-30.png" alt="avatar">
                        </div>
                                ...
                                <div class="widget-content">
                                    <div class="account-box">
                                        ...
                                        <div class="info-box">
                                            <div class="icon">
                                                <span>
                                                    <img src="<?= base_url()?>assets/assets/img/money-bag.png" alt="money-bag">
                                                </span>
                                            </div>
                                    ...
                                    <div class="meta-info">
                                        ...
                                        <div class="avatar--group">
                                            ...
                                            <div class="avatar translateY-axis">
                                                <img alt="avatar" src="<?= base_url()?>assets/assets/img/profile-8.jpg"/>
                                            </div>
                                            <div class="avatar translateY-axis">
                                                <img alt="avatar" src="<?= base_url()?>assets/assets/img/profile-12.jpg"/>
                                            </div>
                                            <div class="avatar translateY-axis">
                                                <img alt="avatar" src="<?= base_url()?>assets/assets/img/profile-19.jpg"/>
                                            </div>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                            <div class="widget widget-card-one">
                                <div class="widget-content">
                                    ...
                                    <div class="media">
                                        <div class="w-img">
                                            <img src="<?= base_url()?>assets/assets/img/profile-19.jpg" alt="avatar">
                                        </div>
                                        <div class="media-body">
                                            <h6>Jimmy Turner</h6>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                            <div class="widget widget-card-two">
                                <div class="widget-content">
                                    ...
                                    <div class="media">
                                        <div class="w-img">
                                            <img src="<?= base_url()?>assets/assets/img/g-8.png" alt="avatar">
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <div class="card-bottom-section">
                                        ...
                                        <div class="img-group">
                                            <img src="<?= base_url()?>assets/assets/img/profile-19.jpg" alt="avatar">
                                            <img src="<?= base_url()?>assets/assets/img/profile-6.jpg" alt="avatar">
                                            <img src="<?= base_url()?>assets/assets/img/profile-8.jpg" alt="avatar">
                                            <img src="<?= base_url()?>assets/assets/img/profile-3.jpg" alt="avatar">
                                        </div>
    ...
    <script src="<?= base_url()?>assets/plugins/src/perfect-scrollbar/perfect-scrollbar.min.js"></script>
    <script src="<?= base_url()?>assets/plugins/src/mousetrap/mousetrap.min.js"></script>
    <script src="<?= base_url()?>assets/plugins/src/waves/waves.min.js"></script>
    <script src="<?= base_url()?>assets/layouts/vertical-light-menu/app.js"></script>
    <!-- END GLOBAL MANDATORY SCRIPTS -->

    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
    <script src="<?= base_url()?>assets/plugins/src/apex/apexcharts.min.js"></script>
