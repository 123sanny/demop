      ...
      <div class="widget widget-t-sales-widget widget-m-sales">
         <div class="media">
            ...
            <div class="media-body">
               <p class="widget-text">Total No of Enquires</p>
               <p class="widget-numeric-value"><?=$enquriy?></p>
            </div>
         </div>
   ...
   <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 layout-spacing">
      <div class="widget widget-t-sales-widget widget-m-orders">
         <div class="media">
            ...
            <div class="media-body">
               <p class="widget-text">Total No of services</p>
               <p class="widget-numeric-value"><?=$services?></p>
            </div>
         </div>
         <!--<div class="d-flex w-bottom">-->
   ...
   <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 layout-spacing">
      <div class="widget widget-t-sales-widget widget-m-income">
         <div class="media">
            ...
            <div class="media-body">
               <p class="widget-text">Total No of Packages</p>
               <p class="widget-numeric-value"><?=$package?>+</p>
            </div>
         </div>
         <!--<div class="d-flex w-bottom">-->
