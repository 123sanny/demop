window.addEventListener("load", function(){
    ...
    if (equationThemeObject.settings.layout.darkMode) {
        ...
        if (!getParseObject.settings.layout.darkMode) {
            ...
            if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('<?= base_url()?>assets/img/logo/logo.png')
                }
            } else {
                // if (document.querySelector('.navbar-logo')) {
                //     document.querySelector('.navbar-logo').setAttribute( " ",getParseObject.settings.layout.logo.lightLogo)
                // }
            }
